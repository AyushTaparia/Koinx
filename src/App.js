  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="w-4/5 h-[108vh] rounded-lg bg-white border border-gray-300 p-8 shadow-md">
          ...
          <div className="flex justify-between">
            ...
            <div className="flex flex-row space-x-4 text-sm text-gray-400 font-medium">
              <ul className="cursor-pointer hover:text-blue-700">1H</ul>
              <ul className="cursor-pointer hover:text-blue-700">24H</ul>
              <ul className="cursor-pointer hover:text-blue-700">7D</ul>
              <ul className="cursor-pointer hover:text-blue-700">1M</ul>
              <ul className="cursor-pointer hover:text-blue-700">3M</ul>
              <ul className="cursor-pointer hover:text-blue-700">6M</ul>
              <ul className="cursor-pointer hover:text-blue-700">1Y</ul>
      ...
      <div className="flex flex-row mt-6 pl-10 text-gray-600 font-medium">
        <ul className="hover:text-blue-800 hover:border-b-2 hover:border-blue-800 cursor-pointer">
          Overview
        </ul>
        <ul className="hover:text-blue-800 hover:border-b-2 hover:border-blue-800 cursor-pointer ml-[8vh]">
          Fundamentals
        </ul>
        <ul className="hover:text-blue-800 hover:border-b-2 hover:border-blue-800 cursor-pointer ml-[8vh]">
          News Insights
      ...
      <div className="flex mt-20">
        <div className="w-full h-[95vh] bg-white border border-gray-300 p-12 shadow-md">
          ...
          <img
            ...
            alt="bnb_one"
            className="h-[44px] absolute mt-[9vh] ml-[-3vh]"
          />
          <img
            src="images/img_button_next_slide_white_a700.svg"
            alt="bnb_one"
            className="h-[44px] absolute ml-[85rem] mt-[9vh]"
          />
          <div className="flex flex-row space-x-6">
            <div className="w-[35vh] h-[25vh] rounded-lg bg-white border border-gray-300 p-4 shadow-md">
              <div className="flex flex-row space-x-1">
                <img
                  src="images/img_img_margin.png"
                  alt="you_may_also"
                  className="w-[5vh] object-cover"
                />
                <p>BNB</p>
                <div className="bg-green-100 h-[3vh] w-[6vh] flex items-center justify-center">
                  <div className="text-green-600 text-xs font-medium">
                    +0.52%
                  </div>
                </div>
              </div>
              <p className="text-xl font-medium mt-1">$319.34</p>
              <img
            ...
            <div className="w-[35vh] h-[25vh] rounded-lg bg-white border border-gray-300 p-4 shadow-md">
              <div className="flex flex-row space-x-1">
                ...
                />
                <p>SOL</p>
                <div className="bg-red-100 h-[3vh] w-[6vh] flex items-center justify-center">
                  <div className="text-red-600 text-xs font-medium">-2.89%</div>
                </div>
              </div>
              <p className="text-xl font-medium mt-1">$109.33</p>
              <img
                src="images/img_202401031434_svg.svg"
                alt="image"
                className="h-[70px] mt-1"
            ...
            <div className="w-[35vh] h-[25vh] rounded-lg bg-white border border-gray-300 p-4 shadow-md">
              ...
              <p className="text-xl font-medium mt-1">$0.634810</p>
              <img
                src="images/img_202401031434_svg.svg"
                alt="image"
                className="h-[70px] mt-1"
            ...
            <div className="w-[35vh] h-[25vh] rounded-lg bg-white border border-gray-300 p-4 shadow-md">
              <div className="flex flex-row space-x-1">
                ...
                <p>ADA</p>
                <div className="bg-red-100 h-[3vh] w-[6vh] flex items-center justify-center">
                  <div className="text-red-600 text-xs font-medium">-1.57%</div>
                </div>
              </div>
              <p className="text-xl font-medium mt-1">$0.614869</p>
              <img
                src="images/img_202401031434_svg.svg"
                alt="image"
                className="h-[70px] mt-1"
            ...
            <div className="w-[35vh] h-[25vh] rounded-lg bg-white border border-gray-300 p-4 shadow-md">
              <div className="flex flex-row space-x-1">
                ...
                <p>AVAX</p>
                <div className="bg-red-100 h-[3vh] w-[6vh] flex items-center justify-center">
                  <div className="text-red-600 text-xs font-medium">-3.78%</div>
                </div>
              </div>
              <p className="text-xl font-medium mt-1">$41.05</p>
              <img
                src="images/img_202401031434_svg.svg"
                alt="image"
                className="h-[70px] mt-1"
